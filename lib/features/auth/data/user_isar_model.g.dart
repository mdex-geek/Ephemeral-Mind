...
void _userIsarSerialize(
  ...
  writer.writeDateTime(offsets[1], object.lastLoginAt);
  writer.writeString(offsets[2], object.passwordHash);
  writer.writeString(offsets[3], object.profileImagePath);
...
UserIsar _userIsarDeserialize(
  ...
  object.id = id;
  object.lastLoginAt = reader.readDateTime(offsets[1]);
  object.passwordHash = reader.readString(offsets[2]);
  object.profileImagePath = reader.readStringOrNull(offsets[3]);
...
extension UserIsarByIndex on IsarCollection<UserIsar> {
  Future<UserIsar?> getByUuid(String uuid) {
    return getByIndex(r'uuid', [uuid]);
  }

  UserIsar? getByUuidSync(String uuid) {
  ...
  Future<List<UserIsar?>> getAllByUuid(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
    return getAllByIndex(r'uuid', values);
  }

  List<UserIsar?> getAllByUuidSync(List<String> uuidValues) {
    final values = uuidValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUuid(UserIsar object) {
    return putByIndex(r'uuid', object);
  }

  Id putByUuidSync(UserIsar object, {bool saveLinks = true}) {
    return putByIndexSync(r'uuid', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUuid(List<UserIsar> objects) {
    return putAllByIndex(r'uuid', objects);
  }

  List<Id> putAllByUuidSync(List<UserIsar> objects, {bool saveLinks = true}) {
    return putAllByIndexSync(r'uuid', objects, saveLinks: saveLinks);
  }

  Future<UserIsar?> getByUsername(String username) {
    return getByIndex(r'username', [username]);
  }

  UserIsar? getByUsernameSync(String username) {
  ...
  Future<List<UserIsar?>> getAllByUsername(List<String> usernameValues) {
    final values = usernameValues.map((e) => [e]).toList();
    return getAllByIndex(r'username', values);
  }

  List<UserIsar?> getAllByUsernameSync(List<String> usernameValues) {
    final values = usernameValues.map((e) => [e]).toList();
  ...
  Future<Id> putByUsername(UserIsar object) {
    return putByIndex(r'username', object);
  }

  Id putByUsernameSync(UserIsar object, {bool saveLinks = true}) {
    return putByIndexSync(r'username', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllByUsername(List<UserIsar> objects) {
    return putAllByIndex(r'username', objects);
  }

  List<Id> putAllByUsernameSync(List<UserIsar> objects,
      {bool saveLinks = true}) {
...
extension UserIsarQueryWhere on QueryBuilder<UserIsar, UserIsar, QWhereClause> {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterWhereClause> uuidEqualTo(String uuid) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterWhereClause> uuidNotEqualTo(
      String uuid) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension UserIsarQueryFilter
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> lastLoginAtEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> lastLoginAtLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterFilterCondition> lastLoginAtBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserIsarQuerySortBy on QueryBuilder<UserIsar, UserIsar, QSortBy> {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByLastLoginAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLoginAt', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByLastLoginAtDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByProfileImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profileImagePath', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> sortByProfileImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQuerySortThenBy
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByLastLoginAt() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLoginAt', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByLastLoginAtDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLoginAt', Sort.desc);
    });
  }
  ...
  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByProfileImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profileImagePath', Sort.asc);
    });
  }

  QueryBuilder<UserIsar, UserIsar, QAfterSortBy> thenByProfileImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'profileImagePath', Sort.desc);
    });
  }
...
extension UserIsarQueryWhereDistinct
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByLastLoginAt() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, UserIsar, QDistinct> distinctByProfileImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserIsarQueryProperty
  ...
  QueryBuilder<UserIsar, DateTime, QQueryOperations> lastLoginAtProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserIsar, String?, QQueryOperations> profileImagePathProperty() {
    return QueryBuilder.apply(this, (query) {
